...
modules_to_test = [
    ...
    ('PyPortfolioOptOptimizer', 'from financial_analyzer.portfolio_optimization.pyportfolioopt_optimizer import PyPortfolioOptOptimizer'),
    ('RiskfolioOptimizer', 'from financial_analyzer.portfolio_optimization.riskfolio_optimizer import RiskfolioOptimizer'),
